...
parser.add_argument("--early_stop", type=int, default=10,help="连续n次eval，loss不下降时停止训练")
parser.add_argument("--max_epoch", type=int, default=10)
parser.add_argument("--output_dir", type=str, default="/opt/data/private/wjk/ml_final_proj/transformers_output")
...
model=Transformer(7, 512, 4, 1, args.output_time_steps,dropout=args.dropout).cuda()
